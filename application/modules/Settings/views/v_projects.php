	...
	<header class="page-header">
		...
		<section class="panel">
			<header class="panel-heading" style=" border: 1px solid #5B707B; padding: 10px 14px; background: #5B707B;">
				<h2 class="panel-title" style="font-size: medium; color: white;"><i class="fa fa-chevron-right"> </i> Project Classification</h2>
			</header>
						...
						<form action="" id="addnew-form" method="post" class="form-horizontal mb-lg" >
							<section class="panel">
								...
								<div class="panel-body">
									...
									<div class="form-group">
										<label class="col-sm-3 control-label">GFAS</label>
										<div class="col-sm-6">
											<input type="text" name="txt_gfas" id="txt_gfas" class="form-control" value="" placeholder="Type GFAS..." required />
										</div>
									</div>
...
(function($) {
	...
	var datatableInit = function() {
		...
		$('#addnew-form').submit(function(e) {
			...
			$.ajax({
				type : "POST",
				url  : '<?=base_url();?>Settings/Projects/do_add',
				data : data,
	...
	function LoadDatatable(){
		...
		var datatable = $table.dataTable({
			bProcessing: true,
			sAjaxSource: '<?=base_url();?>Settings/Projects/data_json_all',
			bDestroy: true,
			aoColumnDefs:[
			{
				bSortable: false,
