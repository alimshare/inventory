	...
	<header class="page-header">
		...
		<section class="panel">
			<header class="panel-heading" style=" border: 1px solid #5B707B; padding: 10px 14px; background: #5B707B;">
				<h2 class="panel-title" style="font-size: medium; color: white;"><i class="fa fa-chevron-right"> </i> Items Classification</h2>
			</header>
...
(function($) {
	...
	function LoadDatatable(){
		...
		var datatable = $table.dataTable({
			bProcessing: true,
			sAjaxSource: '<?=base_url();?>Settings/Items/data_json_all',
			bDestroy: true,
			aoColumnDefs:[
			{
				bSortable: false,
