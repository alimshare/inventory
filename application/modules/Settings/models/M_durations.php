<?php
class M_durations extends CI_Model {
	...
	function get_data_json_all($str='')
    {
        ...
        foreach($result->result() as $row)
        {
			...
			"<a  href='#modalForm' link-href='".base_url()."Settings/Durations/edit/".$row->item_id."' class='modal-with-zoom-anim on-default link-edit' title='Edit Row'><i class='fa fa-pencil'></i></a>
			<a  href='#modalConfirm' link-href='".base_url()."Settings/Durations/do_del/".$row->item_id."' class='modal-with-zoom-anim on-default link-del' data-del='".$row->item_name."'title='Delete Row'><i class='fa fa-trash-o'></i></a>"
			);
			$i++;
        }
        return $data;
