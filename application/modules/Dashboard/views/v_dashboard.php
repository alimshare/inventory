	...
	<div class="col-md-12 col-lg-12 col-xl-12">
		<section class="panel">
			<div class="panel-body" style="border: 0px solid #232;">
				...
				<a href="#modalRequest" class="col-sm-12 mb-xs mt-xs mr-xs btn btn-lg btn-primary modal-with-zoom-anim on-default"><i class=" fa-2x fa fa-registered"></i><br/><h6><br/>Request Form</h6></a>
				</div>
				<div class="col-md-2" style="border: 0px solid #232; padding-left: 5px; padding-right: 5px;">
				<a href="<?php echo base_url('Purchase_request') ?>" class="col-sm-12 mb-xs mt-xs mr-xs btn btn-lg btn-primary"><i class=" fa-2x fa fa-users"></i><br/><h6>Purchase<br/>Request Form</h6></a>
				</div>
				<div class="col-md-2" style="border: 0px solid #232; padding-left: 5px; padding-right: 5px;">
