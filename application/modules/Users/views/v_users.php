				...
				<div class="row"> 
					...
					<div id="modalForm" class="zoom-anim-dialog modal-block modal-block-primary mfp-hide">
						<form action="" id="addnew-form" method="post" class="form-horizontal mb-lg" enctype="multipart/form-data">
							<section class="panel">
								<header class="panel-heading" style=" border: 1px solid #5B707B; padding: 10px 14px; background: #5B707B;">
									<h2 class="panel-title" style="font-size: medium; color: white;">Add New User</h2>
								</header>
								<div class="panel-body">
									...
									<div class="form-group">
										...
										<div class="col-sm-6">
											<input type="text" name="txt_purpose" id="txt_purpose" class="form-control" value="" placeholder="Type Purpose..." />
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-6">
											...
											<div class="mt-sm">
												<img src="<?php echo base_url().'images/items/no-image.png' ?>" id="preview" width="100%">
											</div>
										</div>
									</div>
