...
class M_users extends CI_Model {
    ...
    private $duplicate1='account_name';
    private $duplicate2='account_name';
    private $table_order='account_name';
    private $table_name='tb_userapp';
    private $site_id='';
	...
	function get_data_json_all($str='')
    {
        ...
        foreach($result->result() as $row)
        {
			...
			"<a  href='".base_url()."Users/vedit/".$row->id."' class='' title='Edit Row'><i class='fa fa-pencil'></i></a>
			<a  href='#modalConfirm' link-href='".base_url()."Users/do_del/".$row->id."' class='modal-with-zoom-anim on-default link-del' data-del='".$row->account_name."'title='Delete Row'><i class='fa fa-trash-o'></i></a>"
			);
			$i++;
        }
        return $data;
    ...
    public function get_data_duplicate($field,$value)
    {
        $sql="SELECT * FROM ".$this->table_name."
            WHERE $field='".$value."'  ";
    ...
    {
        $data=array();
        $sql = "SELECT id,account_name,username,email,project_id,unit_id,loca_id,purpose,create_by,create_date,modify_by,modify_date,signature,role 
