										...
										<div class="col-sm-6">
                                                ...
                                                <div class="col-sm-6">
													<div class="input-group">
														<select required data-plugin-selectTwo class="form-control populate" id="txt_project" name="txt_project">
															<option value="">Select...</option>
															<option value="01.01" <?php if(isset($edit_project)){ if($edit_project=="01.01") { echo "selected";}}else{ if(set_value('txt_project')=="01.01"){ echo "selected";}}?>>01.01 - ASA.USAID</option>
															<option value="02.01" <?php if(isset($edit_project)){ if($edit_project=="02.01") { echo "selected";}}else{ if(set_value('txt_project')=="02.01"){ echo "selected";}}?>>02.01 - SUM.USAID</option>
															<option value="03.01" <?php if(isset($edit_project)){ if($edit_project=="03.01") { echo "selected";}}else{ if(set_value('txt_project')=="03.01"){ echo "selected";}}?>>03.01 - SUM2.USAID</option>
															<option value="04.01" <?php if(isset($edit_project)){ if($edit_project=="04.01") { echo "selected";}}else{ if(set_value('txt_project')=="04.01"){ echo "selected";}}?>>04.01 - TB.USAID</option>
															<option value="05.01" <?php if(isset($edit_project)){ if($edit_project=="05.01") { echo "selected";}}else{ if(set_value('txt_project')=="05.01"){ echo "selected";}}?>>05.01 - Linkages.USAID</option>
															<option value="06.01" <?php if(isset($edit_project)){ if($edit_project=="06.01") { echo "selected";}}else{ if(set_value('txt_project')=="06.01"){ echo "selected";}}?>>06.01 - CTB.USAID</option>
															<option value="07.01" <?php if(isset($edit_project)){ if($edit_project=="07.01") { echo "selected";}}else{ if(set_value('txt_project')=="07.01"){ echo "selected";}}?>>07.01 - DOD.USAID</option>
														</select>
													</div>
												</div>
                                            </div>
                                                ...
                                                <div class="col-sm-4">
													<div class="input-group">
														<select data-plugin-selectTwo class="form-control populate" id="txt_status" name="txt_status">
															...
															<option value="Used" <?php if(isset($edit_status)){ if($edit_status=="Used") { echo "selected";}}else{ if(set_value('txt_status')=="Used"){ echo "selected";}}?> selected>Used</option>
															<option value="Handover" <?php if(isset($edit_status)){ if($edit_status=="Handover") { echo "selected";}}else{ if(set_value('txt_status')=="Handover"){ echo "selected";}}?>>Handover</option>
											...
											<div class="form-group" style="">
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <select name="txt_user" id="txt_user" data-plugin-selectTwo class="form-control populate" >
