					...
					<header class="page-header">
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li><span>Inventory Lists</span></li>
							</ol>
					...
					<div class="row">
						<div class="tabs">
								<ul class="nav nav-tabs">
									<li>
										<a href="<?=base_url();?>Inventories/addnew">Inventory Input Form</a>
									</li>
									<li class="active">
										<a href="<?=base_url();?>Inventories/lists"><b>Inventory Lists</b></a>
									</li>
								</ul>
									...
									<div class="row">
										...
										<div class="col-md-6">
											<div style=" text-align: right; margin-bottom: 5px;">
												<a class="btn btn-default" href="<?=base_url();?>Inventories/lists"><i class="fa fa-undo"></i> Reset</a>
												<a class="btn btn-default" href="#" id="btn_excel"><i class="fa fa-file-excel-o"></i> Excel</a>
												<a class="btn btn-default" href="#" target="_blank" id="btn_barcode"><i class="fa fa-barcode"></i> Barcode</a>
												<a class="btn btn-default" href="<?=base_url();?>Inventories/print_barcode2" target="_blank"><i class="fa fa-barcode"></i> Barcode 5x5,5</a>
											</div>
										</div>
									</div>
