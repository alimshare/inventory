			...
			<div class="center-sign">
				...
				<div class="panel panel-sign">
					...
					<div class="panel-body">
						...
						<form action="<?php echo base_url('Login/reset_password_submit') ?>" method="post">
							...
							<div class="form-group mb-lg">
								...
								<div class="input-group input-group-icon">
									<input name="txt_login_pass1" id="txt_login_pass1" type="password" class="form-control input-lg" />
							...
							<div class="form-group mb-lg">
								...
								<div class="input-group input-group-icon">
									<input name="txt_login_pass2" id="txt_login_pass2" type="password" class="form-control input-lg" />
									<span class="input-group-addon">
										<span class="icon icon-lg">
											<i class="fa fa-lock"></i>
										</span>
							...
							<div class="row">
								...
								<div class="col-sm-8 text-right">
									<button type="submit" id="btn_signin" class="btn btn-primary hidden-xs"><span class="glyphicon glyphicon-log-in"></span> &nbsp; Change Password</button>
								</div>
							</div>
						</form>
					</div>
